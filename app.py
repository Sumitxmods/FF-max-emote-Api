...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('16394735141')  # YAHA PE GUEST UID DALNA HAI 

    Uid, Pw = '5563822761', 'B1B2BFAB160047DA16C664B097534A9BECECF383D4ED53297BCE8D5C5EB8EA25'
    ...
    # ✅ YEH LINE COMMENT KAR DI (Flask thread hataya)
...
# ✅ YAHAN SIRF PORT ADD KIYA HAI
if __name__ == '__main__':
    # Flask ko pehle start karo (main thread mein), bot background mein
    import threading
    ...
    # Flask start karo (port add kiya)
    port = int(os.environ.get('PORT', 10000))
    app.run(host='0.0.0.0', port=port, debug=False, use_reloader=False)